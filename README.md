...
| 🇫🇷 [**Français**](#-alldebrid-manager--français) | 🇬🇧 [**English**](#-alldebrid-manager--english) |
|:---:|:---:|
...
<a id="--alldebrid-manager--français"></a>
...
🔝 [Retour au sélecteur de langue / Back to language selector](#-choose-your-language--choisissez-votre-langue)
...
<a id="--alldebrid-manager--english"></a>
